...
class RpmSpecCollection(object):
    ...
    def compute_order(self):
        '''Compute the order to build the packages according to the
BuildRequires and Requires fields of the packages (including
sub-packages).'''
        self.pkg = {}           # sub-package to package associative array
        self.order = []         # list to return the computed order
        self.color = {}         # keep status of the progress by
    ...
    def _visit(self, spec):
        '''Helper function for compute_order that implements the recursive walk
