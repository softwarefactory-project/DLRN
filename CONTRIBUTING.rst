...
.. code-block:: yaml
    ...
    runcmd:
      ...
      - git clone https://github.com/javierpena/puppet-delorean /root/puppet-delorean
      - cd /root/puppet-delorean
      - puppet module build
      - puppet module install pkg/jpena-delorean-*.tar.gz
      - cp /root/puppet-delorean/examples/common.yaml /var/lib/hiera
      - puppet apply --debug /root/puppet-delorean/examples/site.pp 2>&1 | tee /root/puppet.log
