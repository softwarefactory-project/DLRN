...
mock -r $(dirname $0)/delorean.cfg --postinstall --resultdir $OUTPUT_DIRECTORY --rebuild ${TOP_DIR}/SRPMS/*.src.rpm 2>&1 | tee $OUTPUT_DIRECTORY/mock.log

if ! fgrep 'WARNING: Failed install built packages' $OUTPUT_DIRECTORY/mock.log; then
