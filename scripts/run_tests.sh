...
RDOINFO="${1}"
ZUUL_GIT_BASE_URL="https://review.rdoproject.org/r/p"
...
PROJECT_TO_BUILD=${PROJECT:-python-glanceclient}
...
if [[ ! -z "${ZUUL_PROJECT}" ]]; then
    ...
    type -p zuul-cloner
    zuul-cloner --workspace data/ $ZUUL_GIT_BASE_URL $ZUUL_PROJECT
