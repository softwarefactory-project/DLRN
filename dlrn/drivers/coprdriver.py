...
class CoprBuildDriver(BuildRPMDriver):
    ...
    def build_package(self, **kwargs):
        ...
        try:
            ...
            # Directory should contains only on directory that is chroot name
            # + coprdownload.log
            build_dir_content = os.listdir(output_dir)
            build_dir_content.remove("coprdownload.log")
            target_dir = os.path.join(
                output_dir, build_dir_content[0])
