...
class BrewBuildDriver(BuildRPMDriver):
    ...
    def build_package(self, **kwargs):
        ...
        package_name = "XXX: THIS ISN'T AVAILABLE HERE YET"
        # need to pass package_name or distgit_dir (prefered) into this driver
        # or deduce from .src.rpm name but that isn't robust.
        ...
        rhpkg = sh.rhpkg.bake(_cwd=distgit_dir, _tty_out=False, _timeout=3600)
