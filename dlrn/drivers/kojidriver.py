...
class KojiBuildDriver(BuildRPMDriver):
    ...
    def build_package(self, **kwargs):
        ...
        keytab_file = self.config_options.koji_keytab
        ...
        try:
            ...
            with open("%s/kojibuild.log" % output_dir, 'a') as self.koji_fp:
                try:
            ...
            with open("%s/kojidownload.log" % output_dir, 'a') as self.koji_fp:
                try:
                    sh.env(run_cmd, _err=self._process_koji_output,
                           _out=self._process_koji_output,
