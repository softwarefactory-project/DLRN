...
class BuildahDriver(BuildContainerDriver):
    ...
    def build(self, container, mnt, rpms):
        ...
        # TODO: setup delorean-deps and consistent repo file
        for rpm in rpms:
    ...
    def build_container(self, commit):
        ...
        # TODO: select base image based on mock config
        ...
        # TODO: iterate over sub-package and build a layer for each %{_bindir}
        # TODO: setup command-line based on systemd service file
        return [tagname]
