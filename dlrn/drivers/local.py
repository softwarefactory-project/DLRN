...
class LocalDriver(PkgInfoDriver):
    ...
    def _get_infos_from_pkg(self, packagepath):
        ...
        return pkgfile.replace('.spec', ''), version
    ...
    def getinfo(self, **kwargs):
        ...
        if os.path.isdir(os.path.join(package['master-distgit'], '.git')):
