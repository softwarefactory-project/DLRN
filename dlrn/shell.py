...
def main():
    ...
    parser.add_argument('--build-type',
                        choices=('rpm', 'container'),
                        help="Restrict to a single type of build")
    ...
    if config_options.container_build_driver and not options.build_type:
        build_types.append("container")
