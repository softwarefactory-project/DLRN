...
def main():
    ...
    parser.add_argument('--stop', action="store_true",
                        help="Stop on error.")
    parser.add_argument('--verbose-build-output', action="store_true",
    ...
    if options.verbose_mock:
        logger.warning('The --verbose-mock command-line option is deprecated.'
                       ' Please use --verbose-build-output instead.')
        options.verbose_build_output = options.verbose_mock
    global verbose_output
    verbose_output = options.verbose_build_output
