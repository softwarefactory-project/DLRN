...
usage: dlrn-remote [-h] --config-file CONFIG_FILE --remote-yaml REMOTE_YAML
                   --repo-url REPO_URL [--info-repo INFO_REPO]

arguments:
  -h, --help            show this help message and exit
  --config-file CONFIG_FILE
                        Config file (required)
  --remote-yaml REMOTE_YAML
                        URL for remotely generated DLRN yaml file (required)
...
.. code-block:: console
    ...
    $ dlrn-remote --config-file projects.ini \ 
      --remote-yaml http://<builder IP>/repos/<hash>/commit.yaml \
